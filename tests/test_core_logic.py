...
class TestActivityTrackerLogic(unittest.TestCase):
    ...
    def test_calculate_time_in_current_minute_before_boundary(self):
        ...
        with patch("activity_tracker.core.time.time", return_value=1030.0):
            result = self.tracker._calculate_time_in_current_minute(start_time, last_boundary)
    ...
    def test_save_final_data(self):
        ...
        self.tracker.monitor.session_tracker.add_activity.assert_called_with("App", 10.0)
        # Should save merged data
        self.tracker.data_store.merge_and_save_session_data.assert_called_with({"Other": 5})
    ...
    def test_track_activity_loop(self):
        ...
        with patch("activity_tracker.core.time.sleep", side_effect=stop_loop) as mock_sleep:
    ...
    def test_track_activity_exception(self):
        ...
        self.tracker.monitor.idle_detector.check_idle_state.side_effect = Exception("Test Error")
